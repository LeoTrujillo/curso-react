...
import CourseAddForm from './CoursesAddForm';
import CourseList from './CourseList';
import CourseSearch from './CoursesSearch';
    ...
    if (!this.state.courses.length) {
      ...
      return(
        <article className="Main-container">
          ...
          <CourseSearch onSearch={this.handleOnSearch} />
          <CourseList courses={this.handleOnFilter(this.state.filter, this.state.courses)} />
        </article>
      )
    }
  }
